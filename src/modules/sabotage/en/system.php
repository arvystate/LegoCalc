...
$module_name = 'Sabotage Calculator'; // Name of the module
$module_requirements  = 'Enemy covert action, your covert action, your spies, your spy lvl, enemy defcon, enemy weapon power, weakest weapon strength, amount, relations'; // What you need to have to work with module
