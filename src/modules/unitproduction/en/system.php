...
$module_name = 'Unit Production'; // Name of the module
$module_requirements  = 'Start and end unit production, amount of Naquadah availible'; // What you need to have to work with module
