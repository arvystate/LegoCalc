...
$module_name = 'Mothership Cost'; // Name of the module
$module_requirements  = 'Start and end - shield, weapon, fleet capacity and quantity, resources availibles'; // What you need to have to work with module
